...
Тестовые аккаунты
    ...
    user_3 ||  user_3@test.com  || testpass123 || 
    
    admin ||  admin@test.com  || superpass123 || 

------------------------------------------------------------------------------------------------------------------------
ДЗ 20. Страница Contacts (DZ20_Contacts)
------------------------------------------------------------------------------------------------------------------------
###СДЕЛАНО

[x] - Прописал flatpages и ckeditor в settings. Поменял индексную страницу.

[x] - Сделал миграции. Добавил и подключил flat pages about и contacts.

[x] - Добавил настройки CKEditor и модуль admin в core

[x] - Добавил пагинацию студентам. Добавил контекст-процессор в core 

[x] - Подключил и настроил CKeditor. Поправил флэтпейджи, добавил media и uploads 

[x] - Настроил пагинацию учителям, группам и курсам

[x] - Сделал сквозную нумерацию списков при пагинации во всех моделях

[x] - Добавил поле avatar в модель accounts. Подключил медиафайлы. Добавил сообщение об успешной регистрации

[x] - Подключил кастомную админку. Поправил requirements.

[x] - Прибрал мусор. Подготовил проект к выгрузке на GH.


------------------------------------------------------------------------------------------------------------------------
ДЗ 19. Admin site (DZ19_AdminSite)
------------------------------------------------------------------------------------------------------------------------
###СДЕЛАНО

[x] - Поменял сообщение на индексной странице

[x] - Создал суперюзера, добавил студентов в админку, поменял таймзону

[x] - Добавил группы в админку. Пытался пробросить учителей в inline группы.

[x] - Добавил учителей в админку

[x] - Добавил курсы в админку

[x] - Подключил middleware

[x] - Подключил службу сообщений

[x] - Добавил inline таблицу учителей в группы. Криво, но работает. Работает? Не трогай! ))

[x] - Добавил учителям фильтр по группам и группы в inline

[x] - Добавил группам курсы и курсам группы в основные таблицы.

[x] - Добавил скрытие edit и delete  полей  в list_шаблонах всех моделей

[x] - Прибрал мусор. Подготовил проект к выгрузке на GH

-----------------------------------------------------------------------------------------------------------------------
ДЗ 18. Регистрация пользователя (DZ18_LoginLogout)
-----------------------------------------------------------------------------------------------------------------------
#Можно сделать

- Назначение студента в группу через группу

- Оптимизировать запросы у курсов и групп. 

###СДЕЛАНО

[x] - Создал приложение accounts. Зарегистрировал. Прописал урлы. Закинул материалы урока

[x] - Сделал миграцию. Исправил урл в главном маршрутизаторе. Поправил шаблоны index и menu.

[x] - Настроил шаблоны аккаунта под стиль проекта. Настроил вью и формы. 

[x] - Настроил почтовый сервер, настроил сброс-восстановление, изменение пароля.  Поправил соотв. шаблоны. 

[x] - Добавил LoginRequiredMixin в create-update-delete вьюхи всем приложениям  

[x] - Добавил отображение имени пользователя и аватарки при логине на месте Accounts

[x] - Прибрал мусор. Подготовил проект к выгрузке на GH.

-----------------------------------------------------------------------------------------------------------------------
ДЗ 17. Работа с CBV (DZ17_CBV)
-----------------------------------------------------------------------------------------------------------------------
###СДЕЛАНО

[x] - Добавил CBV в core

[x] - Добавил Update CBV студентам. Прописал url. Пытался пробросить context.

[x] - Добавил list, create, delete CBV студентам. Прописал маршруты, поправил list-шаблон

[x] - Прибрал мусор во вьюхах и урлах студентов

[x] - Добавил CBV группам. Прописал урлы. Поправил формы и шаблоны

[x] - Добавил CBV учителям. Прописал урлы. Поправил формы и шаблоны. Прибрал мусор

[x] - Добавил CBV курсам. Прописал урлы. Поправил формы и шаблоны. Прибрал мусор

[x] - Добавил список групп в update-шаблон учителя. Поправил list-view группы

[x] - Добавил caption к таблицам во всех update-шаблонах учителей, групп и курсов.

[x] - Добавил инфу в README.md
